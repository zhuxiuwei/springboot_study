...
public class HelloServiceAutoConfiguration {
    ...
    /*
     ...
     会导致客户端（如boot-10-custom-starter-test的boot.config.MyConfig）主动生成并注册HelloService时，启动App会报错HelloProperties找不到：Field helloProperties in com.xiuwei.hello.service.HelloService required a bean of type 'com.xiuwei.hello.bean.HelloProperties' that could not be found.
     */
